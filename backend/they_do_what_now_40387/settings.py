"""
Django settings for they_do_what_now_40387 project.
...
ROOT_URLCONF = 'they_do_what_now_40387.urls'
...
WSGI_APPLICATION = 'they_do_what_now_40387.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "they_do_what_now_40387 API",
    "DESCRIPTION": "API documentation for they_do_what_now_40387 App",
    "VERSION": "v1",
}
